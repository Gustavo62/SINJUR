class CadastroAtendimentosController < ApplicationController
  ...
  after_action  :send_avisoAtendimentoAdd, only: [:create]
  def send_avisoAtendimentoAdd
    PessoaMailer.with(cadastro_atendimento: @cadastro_atendimento).avisoAtendimentoAdd.deliver_now!
  end
